...
public final class QueryUtils {
    ...
    public static ArrayList<quake> fetchEarthquakeData(String requestUrl) {
        ...
        @Nullable
        public static ArrayList<quake> extractFeatureFromJson(String json_response)
        {
        ...
        try {
            ...
            JSONArray ar=reader.optJSONArray("features");
            for(int i=0;i<ar.length();i++)
            {
                JSONObject obj=ar.optJSONObject(i);
                JSONObject property=obj.optJSONObject("properties");
                double mag=property.optDouble("mag");
                String place=property.optString("place");
                long time=property.optLong("time");
                String url=property.optString("url");
                earthquake.add(new quake(mag,place,time,url));
            }
